  ...
  return (
    ...
    >
      {coupons.map((c, i) => (
        ...
        >
          <div className="text-secondary border-6 md:border-8 border-secondary rounded-full size-20 md:size-26 flex flex-col items-center justify-center gap-0"><span className="font-bold text-2xl md:text-4xl">{c.discount}</span> <span className="font-semibold">OFF</span></div>
