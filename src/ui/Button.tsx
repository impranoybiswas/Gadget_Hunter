...
export default function Button({
  ...
  return (
    <motion.button
      ...
      type={type}
      disabled={disabled}
      className={`rounded-lg relative overflow-hidden group text-shadow-2xs z-0 flex justify-center items-center font-semibold cursor-pointer transition-all duration-500 ease-in-out group 
        ${label && "px-3 gap-2"}
